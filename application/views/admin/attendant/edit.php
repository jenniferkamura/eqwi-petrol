            ...
            <div class="box box-primary">
                ...
                <form action="" method="post" id="user-form" enctype="multipart/form-data">
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" class="btn btn-default" onclick="location.href = '<?= base_url("admin/attendant") ?>'">Cancel</button>
                    </div>
                </form>
            </div>
        ...
        $("#user-form").validate({
            ...
            rules: {
                ...
                login_id: {required: true,
                    ...
                    remote: {url: "<?= base_url('admin/attendant/check_user_exists') ?>", type: "post",
                        data: {
                            id: '<?= $user_id ?>',
                            user_type: '<?= $user_type ?>',
                            type: 'login_id',
...
<?php } ?>
    ...
    function get_stations() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url("admin/attendant/get_stations") ?>',
            dataType: 'json',
