...
class Manager extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->data['privilege'] = $this->common_model->get_menu_privilege($admin_id, "admin/manager");
    ...
    public function index() {
        $this->data['view'] = 'admin/manager/index';
        $this->data['user_data'] = $this->user_model->getAllUser('Manager');
    ...
    public function edit($id) {
        ...
        $this->data['view'] = 'admin/manager/edit';
    ...
    public function export_csv() {
        ...
        fputcsv($output, array('Sr', 'Manager Name', 'Gender', 'Email', 'Mobile', 'Verified', 'Company', 'Date of Birth', 'Address', 'Created Date', 'Status'));

        $user_data = $this->user_model->getAllUser('Manager');
        $i = 0;
    ...
    public function delete($id) {
        ...
        if ($id > 0) {
            ...
            if (!$check) {
                ...
                $this->session->set_flashdata('error', 'Manager have found in orders, you can not delete this manager!');
            }
